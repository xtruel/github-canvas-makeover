...
// RomaMap component temporarily disabled for layout fixes
// All original functionality preserved as comments for future restoration
...
const RomaMap = () => {
  // Temporarily disabled - map component made inert for layout fixes
  return (
...
/*
// === ORIGINAL IMPLEMENTATION PRESERVED FOR FUTURE RESTORATION ===

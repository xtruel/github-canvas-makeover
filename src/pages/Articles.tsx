  ...
  const mockArticles = [
    {
      ...
      excerpt: "Analisi approfondita delle scelte tattiche e tecniche del nuovo allenatore giallorosso. Come cambierà il gioco della Roma nella prossima stagione.",
    ...
    },
    {
      ...
      excerpt: "Il capitano giallorosso si confida sui suoi sogni, le ambizioni per il futuro e il legame speciale con la città eterna e i tifosi romanisti.",
    ...
    },
    {
      ...
      excerpt: "Tutti i dettagli sui miglioramenti previsti per la casa della Roma. Nuove tecnologie, comfort per i tifosi e sostenibilità ambientale.",
    ...
    },
    {
      ...
      excerpt: "L'argentino parla del suo amore per i colori giallorossi, degli obiettivi personali e di squadra per questa stagione ricca di sfide.",
    ...
    },
    {
      ...
      excerpt: "Un viaggio attraverso i derby più memorabili della storia. Dalle vittorie leggendarie ai momenti che hanno fatto la storia del calcio romano.",
    ...
    },
    {
      ...
      excerpt: "L'ex allenatore portoghese ripercorre i momenti più belli vissuti in giallorosso, dalla Conference League ai rapporti con squadra e tifosi.",
      ...
      <div className="grid gap-8">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          {mockArticles.filter(article => article.featured).map((article) => (
            <Card key={article.id} className="shadow-roma border-border/50 hover:shadow-glow transition-all duration-300 overflow-hidden">
              <div className="relative">
                ...
                />
                <Badge className={`absolute top-4 left-4 ${getBadgeColor(article.category)}`}>
                  {article.category}
                </Badge>
                {article.featured && (
                  <Badge className="absolute top-4 right-4 bg-roma-red text-white">
                    In Evidenza
                  </Badge>
                )}
              </div>
              <CardHeader>
                <CardTitle className="text-xl text-foreground hover:text-roma-gold transition-colors cursor-pointer">
                  {article.title}
                </CardTitle>
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button size="sm" className="bg-roma-gold hover:bg-roma-yellow text-black">
                      Leggi
                    </Button>
                  </div>
                </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mockArticles.filter(article => !article.featured).map((article) => (
              <Card key={article.id} className="shadow-glow border-border/50 hover:shadow-roma transition-all duration-300 overflow-hidden">
                <div className="relative">
                  <img 
                    src={article.imageUrl} 
                    alt={article.title}
                ...
                <CardContent>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button size="sm" variant="outline" className="text-xs hover:bg-roma-gold hover:text-black">
                      Leggi
                    </Button>
                  </div>
                </CardContent>

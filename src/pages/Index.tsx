...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section with Gradient - Full Height */}
      <div className="relative bg-gradient-to-br from-roma-red via-red-500 to-yellow-400 text-white min-h-[100dvh] flex items-center justify-center safe-bottom">
        <div className="w-full md:container md:mx-auto text-center px-4">
          <div className="mb-8">
            <img 
          ...
          <p className="text-lg sm:text-xl mb-8 max-w-2xl mx-auto opacity-90 px-1">
